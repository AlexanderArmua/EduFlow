...
export default function DashboardPage() {
  ...
  const stats = [
    { name: 'Active Professors', value: activeProfessors, color: 'bg-blue-500', link: '/professors' },
    { name: 'Total Subjects', value: totalSubjects, color: 'bg-green-500', link: '/subjects' },
    { name: 'Unread Messages', value: unreadMessages, color: 'bg-yellow-500', link: '/communications' },
    { name: 'Total Students', value: totalStudents, color: 'bg-purple-500', link: '/subjects' },
  ];
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Welcome back! Here&apos;s an overview of your education system.</p>
        </div>
        ...
        <div className="mt-6 sf-card p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold text-gray-900">Active Subjects</h2>
